"""
Django settings for market_38306 project.
...
ROOT_URLCONF = 'market_38306.urls'
...
WSGI_APPLICATION = 'market_38306.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "market_38306 API",
    "DESCRIPTION": "API documentation for market_38306 App",
    "VERSION": "v1",
}
